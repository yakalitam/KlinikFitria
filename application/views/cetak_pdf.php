 ...
 $pdf = new FPDF('P', 'mm','Letter');
        ...
        // $pdf->Cell(60,15,'TOTAL HARGA',1,0,'C');
        // $pdf->Cell(60,15,'UANG MUKA',1,0,'C');
        // $pdf->Cell(60,15,'KEKURANGAN',1,1,'C');

        // $pdf->SetFont('Arial','',10);
        //    $id = $_GET['id'];
        // $data['rawat'] = $this->Rawat_model->get_single_row_rawat($id);
        // foreach ($data as $row){
        //     $pdf->Cell(60,15,"Rp ".number_format($row->totalharga, 0, ".", "."),1,0,'C');
        //     $pdf->Cell(60,15,"Rp ".number_format($row->uangmuka, 0, ".", "."),1,0,'C');
        //     $pdf->Cell(60,15,"Rp ".number_format($row->kurang, 0, ".", "."),1,1,'C');
 $pdf->SetFont('Arial','',10);
             foreach ($data as $row){
